...
def create_lamp_support_1():
    with model("lamp_support_1") as ctx:
        lamp_support_0 = cube(90, 90, 4, "lamp_support") | place(0, 0, 10)

        column1 = cylinder(col_r + 2, 20, "column1") | place(sqr_x, sqr_y, 0)
        column2 = cylinder(col_r + 2, 20, "column2") | place(-sqr_x, sqr_y, 0)
        column3 = cylinder(col_r + 2, 20, "column3") | place(sqr_x, -sqr_y, 0)
        column4 = cylinder(col_r + 2, 20, "column4") | place(-sqr_x, -sqr_y, 0)

        h_column1 = cylinder(col_r + tolerance, 20, "column1") | place(sqr_x, sqr_y, 0)
        h_column2 = cylinder(col_r + tolerance, 20, "column2") | place(-sqr_x, sqr_y, 0)
        h_column3 = cylinder(col_r + tolerance, 20, "column3") | place(sqr_x, -sqr_y, 0)
        h_column4 = cylinder(col_r + tolerance, 20, "column4") | place(-sqr_x, -sqr_y, 0)

        h_supp_column1 = cylinder(
            3 + tolerance, 30, "column1", vertices=8
        ) | place(40, 40, 24)
        h_supp_column2 = cylinder(
            3 + tolerance, 30, "column2", vertices=8
        ) | place(-40, 40, 24)
        h_supp_column3 = cylinder(
            3 + tolerance, 30, "column3", vertices=8
        ) | place(40, -40, 24)
        h_supp_column4 = cylinder(
            3 + tolerance, 30, "column4", vertices=8
        ) | place(-40, -40, 24)

        h_lamp_0 = cylinder(36, 20, "h_lamp") | place(0, 0, 15)

        lamp_support = union([column1, column2, column3, column4, lamp_support_0])
        lamp_support = difference(lamp_support, [
            h_column1, h_column2, h_column3, h_column4, h_lamp_0,
            h_supp_column1, h_supp_column2, h_supp_column3, h_supp_column4,
        ])

        t_lamp_support = lamp_support | rotate(180, 0, 0) | translate(0, 0, -40)
...
def create_lamp_support_2():
    with model("lamp_support_2") as ctx:
        lamp_support = cube(90, 90, 3, "lamp_support") | place(0, 0, -8)

        column1 = cylinder(col_r + 2, 15, "column1") | place(sqr_x, sqr_y, 0)
        column2 = cylinder(col_r + 2, 15, "column2") | place(-sqr_x, sqr_y, 0)
        column3 = cylinder(col_r + 2, 15, "column3") | place(sqr_x, -sqr_y, 0)
        column4 = cylinder(col_r + 2, 15, "column4") | place(-sqr_x, -sqr_y, 0)

        h_column1 = cylinder(col_r + tolerance, 25, "column1") | place(sqr_x, sqr_y, 0)
        h_column2 = cylinder(col_r + tolerance, 25, "column2") | place(-sqr_x, sqr_y, 0)
        h_column3 = cylinder(col_r + tolerance, 25, "column3") | place(sqr_x, -sqr_y, 0)
        h_column4 = cylinder(col_r + tolerance, 25, "column4") | place(-sqr_x, -sqr_y, 0)

        h_lamp_1 = cylinder(20.5 / 2 + tolerance, 3, "h_lamp") | place(0, -16, -7)
        h_lamp_2 = cylinder(20.5 / 2 + tolerance, 3, "h_lamp") | place(-12, 10, -7)
        h_lamp_3 = cylinder(20.5 / 2 + tolerance, 3, "h_lamp") | place(12, 10, -7)
        h_lamp_4 = cylinder(4, 10, "h_lamp") | place(0, 0, -7)

        lamp_support = union([lamp_support, column1, column2, column3, column4])
        lamp_support = difference(lamp_support, [
            h_column1, h_column2, h_column3, h_column4,
            h_lamp_1, h_lamp_2, h_lamp_3, h_lamp_4,
        ])
...
def create_dummy_lamp():
    with model("dummy_lamp") as ctx:
        lamp = cylinder(86 / 2, 25, "lamp") | place(0, 0, -65.5)
...
def create_film_slider_2():
    with model("film_slider_2") as ctx:
        slider = cube(45, 45, 5, "slider") | place(0, 0, -5)
        h_slider_1 = cube(40, 34.5, 30, "h_slider")
