...
_SRC_ROOT = str(Path(__file__).resolve().parent.parent.parent.parent.parent.parent)
...
from tanuki.mori.halo_maps.scene import setup_scene
setup_scene()
from tanuki.mori.halo_maps.naranjos.generate_dsl import generate_naranjos_dsl
generate_naranjos_dsl()
from tanuki.mori.halo_maps.naranjos.level import assemble_naranjos_level
assemble_naranjos_level()

from tanuki.mori.halo_maps.naranjos.validate_bsp import _plane_key
